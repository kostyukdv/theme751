...
<form method="post" action="{$smarty.server.PHP_SELF}?cert={$cert}&step=2" class="px-1">
    ...
    <fieldset>
        ...
        <div class="form-group"><input type="submit" value="{$LANG.ordercontinuebutton}" class="btn btn-primary" /></div>
    </form>
    ...
    <form method="post" action="clientarea.php?action=productdetails">
        ...
        <div class="form-group"><input type="submit" value="{$LANG.invoicesbacktoclientarea}" class="btn btn-default" /></div>
    </form>

    ...
    <form method="post" action="{$smarty.server.PHP_SELF}?action=pwreset">
      ...
      <div class="form-group">
        <div class="input-group input-group-lg">
          ...
          <input type="password" class="form-control" name="newpw" id="password" placeholder="{$LANG.newpassword}" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        <div class="input-group input-group-lg">
          <span class="input-group-addon"><span aria-hidden="true" class="icon icon-lock"></span></span>
          <input type="password" class="form-control" name="confirmpw" id="confirmpw" placeholder="{$LANG.confirmnewpassword}" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
